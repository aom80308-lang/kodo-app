window.EXTRAS = {
 ...
 p2: {
  chapters: [
    ...
    { title: "أنواع المبرمجين", content: "<p>فيه تخصصات كتير في البرمجة:</p><ul style='padding-right:20px;line-height:2;'><li><strong>🌐 Front-End:</strong> اللي المستخدم بيشوفه</li><li><strong>⚙️ Back-End:</strong> السيرفر وقواعد البيانات</li><li><strong>📱 Mobile:</strong> تطبيقات الموبايل</li><li><strong>🤖 AI/Data:</strong> الذكاء الاصطناعي</li><li><strong>🎮 Games:</strong> ألعاب الفيديو</li></ul>" },
    { title: "هل البرمجة صعبة؟", content: "<p>الإجابة الصريحة: <strong>مش صعبة، بس محتاجة وقت وممارسة</strong>.</p><p>زي ما بتتعلم لغة جديدة، البرمجة ليها قواعد ومفردات.</p><p>الحاجات اللي بتخليها سهلة:</p><ul style='padding-right:20px;line-height:2;'><li>ابدأ بلغة سهلة زي Python</li><li>اتعلم شوية كل يوم (30 دقيقة كفاية)</li><li>طبق بإيدك على طول</li></ul>" },
    { title: "ابدأ من هنا", content: "<p>دلوقتي إنتا في بداية رحلتك. تذكر 3 قواعد:</p><ol style='padding-right:20px;line-height:2;'><li><strong>الصبر:</strong> متستعجلش</li><li><strong>الممارسة:</strong> الكود بيتحفظ بالممارسة</li><li><strong>الاستمرار:</strong> أفضل من الجلسات الطويلة المتقطعة</li></ol><p>💡 خلي هدفك تتعلم مهارة جديدة كل أسبوع.</p>" }
  ],
  quizzes: [
    { question: "إيه أهم سبب لتعلم البرمجة؟", answers: ["الترفيه فقط", "شغل ودخل أعلى وإبداع", "مفيش فايدة"], correct: 1 },
    { question: "أفضل طريقة لتعلم البرمجة؟", answers: ["الممارسة اليومية", "قراءة كتاب مرة واحدة", "مشاهدة الفيديوهات بس"], correct: 0 },
    { question: "إيه تخصص Front-End؟", answers: ["التعامل مع السيرفرات", "التعامل مع واجهة المستخدم", "تطوير الألعاب"], correct: 1 },
    { question: "البرمجة محتاجة إيه؟", answers: ["موهبة خارقة", "صبر وممارسة", "جهاز غالي"], correct: 1 },
    { question: "البرمجة صعبة؟", answers: ["صعبة جداً", "مستحيلة", "مش صعبة لكن محتاجة وقت"], correct: 2 }
  ]
},
p3: {
  chapters: [
    { title: "يعني إيه كود؟", content: "<p>الكود = <strong>أوامر</strong> بلغة الكمبيوتر يفهمها وينفذها.</p><p>زي ما بنكتب جملة بالعربي، بنكتب جملة بلغة البرمجة.</p><p>مثال:</p><div style='background:#1E293B;color:#86EFAC;padding:12px;border-radius:8px;direction:ltr;text-align:left;font-family:monospace;font-size:14px;margin:10px 0;'>print(\"أهلاً\")</div>" },
    { title: "خصائص الكود الجيد", content: "<p>الكود الجيد لازم يكون:</p><ul style='padding-right:20px;line-height:2;'><li><strong>واضح:</strong> يفهمه أي حد</li><li><strong>منظم:</strong> فيه ترتيب وسطور</li><li><strong>قصير:</strong> مفيش تكرار بدون داعي</li><li><strong>شغال:</strong> ينفذ اللي مطلوب صح</li></ul><p>💡 الكود بيتقرا أكتر بكتير من ما بيتكتب.</p>" },
    { title: "أنواع الأوامر", content: "<p>4 أنواع أساسية من الأوامر في أي لغة:</p><ol style='padding-right:20px;line-height:2;'><li><strong>الطباعة:</strong> عرض حاجة على الشاشة</li><li><strong>الحساب:</strong> العمليات الحسابية</li><li><strong>الشرط:</strong> لو حصل كذا اعمل كذا</li><li><strong>التكرار:</strong> اعمل نفس الحاجة أكتر من مرة</li></ol>" },
    { title: "ترتيب الأوامر مهم", content: "<p>الكمبيوتر بينفذ الأوامر <strong>بالترتيب من فوق لتحت</strong>.</p><p>مثال:</p><div style='background:#1E293B;color:#86EFAC;padding:12px;border-radius:8px;direction:ltr;text-align:left;font-family:monospace;font-size:14px;margin:10px 0;'>print(\"مرحبا\")<br>print(\"بيك\")<br>print(\"في كودو\")</div>" },
    { title: "أول أوامر في Python", content: "<p>فيه أمرين هتتعلمهم الأول:</p><ul style='padding-right:20px;line-height:2;'><li><code>print()</code> — تطبع حاجة</li><li><code>input()</code> — تاخد مدخل من المستخدم</li></ul><p>مثال:</p><div style='background:#1E293B;color:#86EFAC;padding:12px;border-radius:8px;direction:ltr;text-align:left;font-family:monospace;font-size:14px;margin:10px 0;'>name = input(\"اسمك؟ \")<br>print(\"أهلاً \" + name)</div>" }
  ],
  quizzes: [
    { question: "الكود يعني إيه؟", answers: ["أوامر بلغة الكمبيوتر", "لعبة", "صورة"], correct: 0 },
    { question: "الكمبيوتر بينفذ الأوامر إزاي؟", answers: ["بالترتيب من فوق لتحت", "عشوائياً", "بالبحث الذكي"], correct: 0 },
    { question: "إيه أهم خصائص الكود الجيد؟", answers: ["طويل", "واضح ومنظم", "بلغة صعبة"], correct: 1 },
    { question: "الأمر input() بيعمل إيه؟", answers: ["يطبع", "ياخد مدخل من المستخدم", "يحفظ ملف"], correct: 1 },
    { question: "ليه ترتيب الأوامر مهم؟", answers: ["مش مهم", "لأن الكمبيوتر ينفذ بالترتيب", "لأنه بيطبع بالترتيب"], correct: 1 }
  ]
},
p4: {
  chapters: [
    { title: "إزاي الكمبيوتر بيشتغل؟", content: "<p>الكمبيوتر مش ساحر، بيشتغل بخطوات:</p><ol style='padding-right:20px;line-height:2;'><li><strong>📖 يقرأ:</strong> السطر الأول</li><li><strong>🤔 يفهم:</strong> يترجمه للغة الآلة</li><li><strong>⚙️ ينفذ:</strong> يعمل اللي مكتوب</li><li><strong>➡️ ينتقل:</strong> للسطر اللي بعده</li></ol>" },
    { title: "الأخطاء (Errors)", content: "<p>لو لقى أمر مش مفهوم، بيوقف ويطلعلك <strong>خطأ (Error)</strong>.</p><p>أنواع الأخطاء الشائعة:</p><ul style='padding-right:20px;line-height:2;'><li><strong>SyntaxError:</strong> كتابة غلط</li><li><strong>NameError:</strong> متغير مش موجود</li><li><strong>TypeError:</strong> نوع بيانات غلط</li></ul><p>💡 متخافش من الأخطاء، هي جزء من التعلم.</p>" },
    { title: "أهمية الأخطاء", content: "<p>الأخطاء <strong>صديقك</strong> مش عدوك:</p><ul style='padding-right:20px;line-height:2;'><li>بتعرفك إيه اللي غلط</li><li>بتعلمك الصح</li><li>بتخليك مبرمج أحسن</li></ul><p>أي مبرمج محترف بيمر بأخطاء كل يوم.</p>" },
    { title: "إزاي تقرأ الخطأ؟", content: "<p>لما يظهرلك خطأ، اقرأ الرسالة من الآخر للأول:</p><ol style='padding-right:20px;line-height:2;'><li><strong>آخر سطر:</strong> نوع الخطأ والوصف</li><li><strong>السطر اللي فوقه:</strong> مكان الخطأ (رقم السطر)</li><li><strong>الكود:</strong> شوف السطر ده إيه المشكلة فيه</li></ol><p>💡 جوجل صاحبك — ابحث عن رسالة الخطأ.</p>" },
    { title: "تجنب الأخطاء", content: "<p>عشان تقلل الأخطاء:</p><ul style='padding-right:20px;line-height:2;'><li>اكتب الكود بتركيز</li><li>جرب الكود كل شوية (مش تكتب كله مرة واحدة)</li><li>اقرأ الكود قبل التشغيل</li><li>استخدم التعليقات للتوضيح</li></ul>" }
  ],
  quizzes: [
    { question: "الكمبيوتر بيعمل إيه أول حاجة؟", answers: ["ينفذ", "يقرأ السطر", "يخمن"], correct: 1 },
    { question: "لو فيه أمر مش مفهوم؟", answers: ["يتجاهله", "يخمن", "يطلع خطأ"], correct: 2 },
    { question: "إيه نوع الخطأ اللي بيجي من كتابة غلط؟", answers: ["SyntaxError", "NameError", "TypeError"], correct: 0 },
    { question: "الأخطاء صديق ولا عدو؟", answers: ["عدو", "صديق", "مش مهم"], correct: 1 },
    { question: "أحسن طريقة لتجنب الأخطاء؟", answers: ["متجربش", "جرب كل شوية", "اكتب الكود مرة واحدة"], correct: 1 }
  ]
},
p5: {
  chapters: [
    { title: "لغات عالية المستوى", content: "<p>قريبة من لغة البشر، سهلة التعلم والقراءة.</p><p>أمثلة:</p><ul style='padding-right:20px;line-height:2;'><li><strong>Python</strong> 🐍</li><li><strong>JavaScript</strong> 🌐</li><li><strong>Java</strong> ☕</li><li><strong>C#</strong></li></ul><p>بتحتاج مترجم يحولها للغة الآلة.</p>" },
    { title: "لغات منخفضة المستوى", content: "<p>قريبة من لغة الآلة (0 و 1).</p><p>أمثلة:</p><ul style='padding-right:20px;line-height:2;'><li><strong>Assembly</strong></li><li><strong>Machine Code</strong></li></ul><p><strong>الميزة:</strong> أسرع في التنفيذ<br><strong>العيب:</strong> صعبة جداً في التعلم</p>" },
    { title: "الفرق بينهم", content: "<p>مقارنة سريعة:</p><ul style='padding-right:20px;line-height:2;'><li><strong>سهولة التعلم:</strong> عالية ✅ / منخفضة ❌</li><li><strong>سرعة التنفيذ:</strong> أبطأ / أسرع</li><li><strong>الاستخدام:</strong> تطبيقات عامة / أنظمة تشغيل</li></ul>" },
    { title: "ليه نبدأ بالعالية؟", content: "<p>لأنها:</p><ul style='padding-right:20px;line-height:2;'><li>سهلة التعلم</li><li>مطلوبة في السوق</li><li>بتخليك تركز على التفكير المنطقي</li><li>بتقلل الأخطاء</li></ul><p>بعد ما تتقن العالية، تقدر تتعلم المنخفضة لو احتجت.</p>" },
    { title: "أشهر اللغات في 2026", content: "<p>ترتيب أشهر اللغات:</p><ol style='padding-right:20px;line-height:2;'><li><strong>Python</strong> — للـ AI والبيانات</li><li><strong>JavaScript</strong> — للمواقع</li><li><strong>Java</strong> — للتطبيقات الكبيرة</li><li><strong>C#</strong> — للألعاب والويندوز</li></ol>" }
  ],
  quizzes: [
    { question: "Python لغة من أي نوع؟", answers: ["عالية المستوى", "منخفضة المستوى", "مش لغة"], correct: 0 },
    { question: "اللغات المنخفضة تتميز بإيه؟", answers: ["سهلة التعلم", "أسرع في التنفيذ", "شكلها حلو"], correct: 1 },
    { question: "المبتدئ يبدأ بأنهي نوع؟", answers: ["منخفضة", "عالية", "مش مهم"], correct: 1 },
    { question: "JavaScript بتستخدم في؟", answers: ["المواقع", "الطباعة", "الرياضيات"], correct: 0 },
    { question: "ليه نبدأ بلغة عالية المستوى؟", answers: ["سهلة ومطلوبة", "صعبة", "نادرة"], correct: 0 }
  ]
},
p6: {
  chapters: [
    { title: "Python إيه؟", content: "<p>Python هي لغة برمجة <strong>قوية وسهلة</strong>. اسمها جاي من فرقة كوميدية مشهورة.</p><p>ظهرت سنة 1991 على يد <strong>جيدو فان روسم</strong>.</p>" },
    { title: "ليه Python الأفضل للمبتدئين؟", content: "<ul style='padding-right:20px;line-height:2;'><li>✅ <strong>سهلة القراءة:</strong> كودها شبه الإنجليزي</li><li>✅ <strong>مجتمع ضخم:</strong> أي مشكلة تلاقي حل</li><li>✅ <strong>مكتبات كتير:</strong> جاهزة لكل حاجة</li><li>✅ <strong>مطلوبة في السوق:</strong> شركات كتير بتدور عليها</li></ul>" },
    { title: "استخدامات Python", content: "<p>Python بتستخدم في:</p><ul style='padding-right:20px;line-height:2;'><li><strong>🤖 الذكاء الاصطناعي:</strong> ChatGPT و TensorFlow</li><li><strong>📊 تحليل البيانات:</strong> Pandas و NumPy</li><li><strong>🌐 المواقع:</strong> Django و Flask</li><li><strong>🎮 الألعاب:</strong> Pygame</li></ul>" },
    { title: "شركات بتستخدم Python", content: "<p>شركات عالمية بتستخدم Python:</p><ul style='padding-right:20px;line-height:2;'><li>🔵 Google</li><li>📷 Instagram</li><li>🎵 Spotify</li><li>📦 Dropbox</li><li>🎬 Netflix</li><li>🚀 NASA</li></ul>" },
    { title: "ابدأ بـ Python", content: "<p>لو إنتا مبتدئ، Python هي أفضل اختيار.</p><p>الأسباب:</p><ol style='padding-right:20px;line-height:2;'><li>سهلة تتعلم في أسابيع</li><li>تقدر تعمل مشاريع حقيقية بسرعة</li><li>بتفتحلك مجالات كتير</li></ol><p>💡 خلي هدفك تخلص أساسيات Python في شهر.</p>" }
  ],
  quizzes: [
    { question: "Python لغة من أي سنة؟", answers: ["1970", "1991", "2010"], correct: 1 },
    { question: "Python بتستخدم في؟", answers: ["AI والمواقع والبيانات", "الطبخ", "النحت"], correct: 0 },
    { question: "إيه مميزات Python؟", answers: ["صعبة", "سهلة ومطلوبة", "نادرة"], correct: 1 },
    { question: "أنهي شركة بتستخدم Python؟", answers: ["Google", "شركة الأثاث", "مطعم"], correct: 0 },
    { question: "المبتدئ يبدأ بـ؟", answers: ["Python", "Assembly", "Machine Code"], correct: 0 }
  ]
},
p7: {
  chapters: [
    { title: "Compiler إيه؟", content: "<p><strong>Compiler (المترجم):</strong> بيترجم الكود <strong>كله مرة واحدة</strong> قبل التشغيل.</p><p>لو فيه خطأ واحد، مش هيشتغل خالص.</p><p>أمثلة: C, C++, Java</p>" },
    { title: "Interpreter إيه؟", content: "<p><strong>Interpreter (المفسّر):</strong> بيقرأ الكود <strong>سطر سطر</strong> وينفذ على طول.</p><p>لو فيه خطأ، هيتوقف عنده بس اللي قبله اشتغل.</p><p>أمثلة: Python, JavaScript</p>" },
    { title: "المقارنة", content: "<p>الفرق بينهم:</p><ul style='padding-right:20px;line-height:2;'><li><strong>Compiler:</strong> أسرع في التنفيذ</li><li><strong>Interpreter:</strong> أسرع في التطوير</li></ul><p>💡 المبتدئ يفضل Interpreter عشان يجرب بسرعة.</p>" },
    { title: "ليه Python Interpreter؟", content: "<p>Python بتستخدم <strong>Interpreter</strong>.</p><p>يعني:</p><ul style='padding-right:20px;line-height:2;'><li>بتكتب سطر</li><li>تشغله على طول</li><li>تشوف النتيجة</li><li>تعدل وتجرب تاني</li></ul><p>ده بيخلي التعلم أسرع وأمتع.</p>" },
    { title: "ليه ده مهم ليك؟", content: "<p>عشان تفهم:</p><ol style='padding-right:20px;line-height:2;'><li>لما تلاقي خطأ في Python، هيوقف عند السطر بس</li><li>الأسطر اللي قبله اشتغلت عادي</li><li>تقدر تشغل الكود أجزاء أجزاء</li></ol>" }
  ],
  quizzes: [
    { question: "Python بتستخدم Compiler ولا Interpreter؟", answers: ["Compiler", "Interpreter", "الاتنين"], correct: 1 },
    { question: "Interpreter بيقرأ الكود إزاي؟", answers: ["كله مرة واحدة", "سطر سطر", "عشوائي"], correct: 1 },
    { question: "ميزة Compiler؟", answers: ["أسرع في التنفيذ", "أسهل في التطوير", "بيقرأ سطر سطر"], correct: 0 },
    { question: "لو فيه خطأ في Interpreter؟", answers: ["يتجاهل الكود", "يتوقف عنده", "يمسح الكود"], correct: 1 },
